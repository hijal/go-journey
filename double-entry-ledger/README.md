...
`cash`-এর উপর `Credit` method call করে `50000` cents দিয়ে (Rs.500 বা $500). এতে cash balance `50000` হয়ে যায়.
...
Calls the `Credit` method on `cash` with `50000` cents (Rs.500.00 / $500). This increases the cash balance to `50000`.
